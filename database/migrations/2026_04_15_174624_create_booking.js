...
async function up({context: QueryInterface}) {
  await QueryInterface.createTable('bookings', {
   ...
   startDate: { type: DataTypes.DATEONLY,  allowNull: false, 
    ...
    totalPrice: { type: DataTypes.INTEGER,  allowNull: true, validate: { max: 2147483647, min: 0 } }, // allowNull: true -> nem kötelező így megengedjük
    userUID: { type: DataTypes.STRING,  allowNull: false, validate: {
        minHossz(value) {
